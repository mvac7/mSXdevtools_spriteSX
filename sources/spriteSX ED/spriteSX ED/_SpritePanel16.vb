Public Class _SpritePanel16
    ...
    Private Const _WIDTH As Integer = 15
    Private Const _HIGH As Integer = 15
    ...
    Private Sub SpritePanel16_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    'Private Sub Panel16Picture_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Panel16Picture.Paint
    '    'Dim agfx As Graphics = sender.CreateGraphics

    '    'agfx.FillRectangle(Brushes.Yellow, 10, 10, 20, 20)
    ...
    ''' <remarks></remarks>
    Private Sub putPixelZoom(ByVal Xpos As Integer, ByVal Ypos As Integer, ByVal value As Boolean)
        ...
        If value Then
            BrushColor = New SolidBrush(_PaletteData.getRGB(Me._inkColor))
        Else
            BrushColor = New SolidBrush(_PaletteData.getRGB(Me._bgColor))
        End If
    ...
    Private Sub putPixelPreview(ByVal Xpos As Byte, ByVal Ypos As Byte, ByVal state As Boolean)
        ...
        If state Then
            tmpColor = _PaletteData.getRGB(Me._inkColor)
        Else
            tmpColor = _PaletteData.getRGB(Me._bgColor)
        End If
