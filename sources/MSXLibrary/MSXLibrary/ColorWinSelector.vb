...
Public Class ColorWinSelector
    ...
    Public Sub CopyColor(ByVal _sourceValue As Integer, ByVal _targetValue As Integer)
        ...
        Me.PaletteColors.SetColor(_targetValue, sourceColor.Clone)
    ...
    Public Sub ChangeColor(ByVal _sourceValue As Integer, ByVal _targetValue As Integer)
        ...
        Me.PaletteColors.SetColor(_targetValue, sourceColor.Clone)
        Me.PaletteColors.SetColor(_sourceValue, tmpColor.Clone)
        '_targetValue) = sourceColor.Clone
        'Me.PaletteColors.Colors.Item(_sourceValue) = tmpColor.Clone
